...
(function(todo, data, $) {
    ...
    todo.init = function (options) {
        ...
        // },function(){
        //     $("."+defaults.img_edit_Class).show();
        // });
        //Delete by button click
        $("."+defaults.img_delete_Class).click(function(){
